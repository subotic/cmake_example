...
// configuration step. It creates a namespace called `sipi`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", sipi::cmake::project_name, sipi::cmake::project_version) };
